    ...
    <div className="min-h-screen flex items-center justify-center bg-black p-4">
      <Card className="w-full max-w-md p-8 bg-cred-dark-gray border-cred-silver/20">
        <div className="flex flex-col items-center space-y-2 mb-8">
          <CreditCard className="h-12 w-12 text-cred-yellow mb-2" />
          <h1 className="text-2xl font-bold text-white text-center">Cred Risk Predict</h1>
        ...
        <form onSubmit={handleSubmit} className="space-y-6">
          <div className="space-y-2">
            ...
            <Input
              ...
              required
              className="bg-black border-cred-silver/30 focus:border-cred-yellow focus:ring-cred-yellow"
              disabled={isLoading}
            />
          </div>
